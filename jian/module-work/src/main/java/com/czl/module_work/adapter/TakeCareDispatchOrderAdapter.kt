...
class TakeCareDispatchOrderAdapter :
    BaseQuickAdapter<TakeCareDispatchBean.Data, BaseDataBindingHolder<WorkItemTakeCareOrderBinding>>(
        R.layout.work_item_take_care_order
    ) {
    ...
    fun getSelectOrders(): List<TakeCareDispatchBean.Data> {
        val result = mutableListOf<TakeCareDispatchBean.Data>()
        selectPos.forEach {
    ...
    override fun convert(
        ...
        orderItem: TakeCareDispatchBean.Data
    ) {
