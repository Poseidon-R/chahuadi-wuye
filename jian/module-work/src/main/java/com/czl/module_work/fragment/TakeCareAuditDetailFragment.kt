 ...
 * @author：86152
 */
@Route(path = AppConstants.Router.Work.F_WORK_TAKE_CARE_AUDIT_DETAIL)
class TakeCareAuditDetailFragment :
    BaseFragment<WorkFragmentTakeCareAuditDetailBinding, TakeCareAuditDetailViewModel>() {

    private lateinit var mAdapter: MyDispatchDeviceAdapter

    override fun useBaseLayout(): Boolean = false;

    override fun initContentView(): Int = R.layout.work_fragment_take_care_audit_detail
