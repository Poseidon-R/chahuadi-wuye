 ...
 * @author：86152
 */
@Route(path = AppConstants.Router.Work.F_WORK_TAKE_CARE_DISPATCH_DETAIL)
class TakeCareDispatchDetailFragment :
    BaseFragment<WorkFragmentTakeCareDispatchDetailBinding, TakeCareDispatchDetailViewModel>() {
    ...
    override fun initContentView(): Int = R.layout.work_fragment_take_care_dispatch_detail
