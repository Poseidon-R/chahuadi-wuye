 ...
 * @author：86152
 */
class TakeCareAuditDetailViewModel(application: MyApplication, model: DataRepository) :
    ...
    val uc = TakeCareDispatchDetailViewModel.UiChangeEvent()
    ...
    fun audit() {
        ...
        model.inspectTaskCheck(remark, listOf(orderId), isAgree.get() ?: false)
