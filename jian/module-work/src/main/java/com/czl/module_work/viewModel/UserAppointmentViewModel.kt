...
class UserAppointmentViewModel(application: MyApplication, model: DataRepository) :
    ...
    val btnMenu2Click: BindingCommand<Void> = BindingCommand(BindingAction {
        startContainerActivity(AppConstants.Router.Work.F_WORK_DEVICE_APPOINTMENT_RECORD)
    })
